...
MODEL_FILE = os.path.join(ROOT_DIR, "thermoguard_best.pkl")
ENCODER_FILE = os.path.join(ROOT_DIR, "label_encoder_best.pkl")
FEATURE_FILE = os.path.join(ROOT_DIR, "feature_columns_best.pkl")
