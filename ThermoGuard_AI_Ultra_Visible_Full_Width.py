...
/* ============================================================
   FINAL FULL-WIDTH + HIGH-CONTRAST FIX
   This must stay at the VERY END of the CSS.
============================================================ */

/* Force the Streamlit main area to use the full available width */
...
/* New and old Streamlit block-container selectors */
...
/* Make all standard content containers fill the page */
[data-testid="stVerticalBlock"],
[data-testid="stVerticalBlockBorderWrapper"] {
    max-width: none !important;
}

/* Strong readable base text */
[data-testid="stMarkdownContainer"] p,
...
/* Prediction result cards: explicitly override all generic rules */
.risk-high,
.risk-medium,
.risk-low {
...
.risk-high h1 { color: #b91c1c !important; }
.risk-high h3,
.risk-high p { color: #111827 !important; }

.risk-medium h1 { color: #b45309 !important; }
.risk-medium h3,
.risk-medium p { color: #111827 !important; }

.risk-low h1 { color: #047857 !important; }
.risk-low h3,
.risk-low p { color: #111827 !important; }
